...
import Data.Array (all, elem, foldl, group', length, uncons)
...
import Solver (Grid, cellSetFromPuzzle, diagonalOf, gridString, readGrid, solve)
...
test2 :: Effect Result
test2 = do
    str <- generate { difficulty: Beginner, restrictDiag: true, values: Sudoku }
    let solvedStr = gridString $ solveStr false str
...
solveStr :: Boolean -> String -> Grid
solveStr diag str = fromMaybe [] $ (solve diag)
    =<< (flip readGrid str)
